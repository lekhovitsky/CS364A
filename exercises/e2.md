...
In order for $i$ to win the auction, the total surplus of the feasible set with $i$ in it (denote $S^*$) must be greater than or equal to the total surplus of any feasible set without $i$.
